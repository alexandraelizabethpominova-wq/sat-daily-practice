...
export default function App(){
  ...
  const withSidebar=(active:SidebarKey,content:React.ReactNode,background='#fff')=><AppSidebarLayout
    active={active}
  ...
  if(view==='practice'&&current&&qpdf)return withSidebar('practice-tests',<main className="practice">
