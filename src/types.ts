...
export interface Settings { mode:SubjectMode; questionsPerSession:number; showExplanations:boolean; shuffle:boolean; practiceTest?:PracticeTestFilter; selectionMode?:PracticeSelectionMode; failedOnly?:boolean }
