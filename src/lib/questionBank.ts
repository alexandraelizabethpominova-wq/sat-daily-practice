import type { ModuleKey,PracticeQuestion,Subject,SubjectMode } from '../types'
...
function makeModule(module:ModuleKey,subject:Subject,count:number):PracticeQuestion[]{
